...
function congratulations(){
    if (matchedCard.length == 16){
        ...
        finalTime = result.innerHTML;
    //show congratulations modal
    modal.classList.add("pop-up-header");
    //declare star rating variable
    var starRating = document.querySelector(".result").innerHTML;
    //showing move, rating, time on modal
    document.getElementById("fin-Moves").innerHTML = moves;
    document.getElementById("fin-Time").innerHTML = finalTime;
    //closeicon on modal
    closeModal();
    };
}
